...
public class SelectorEdificiosAdaptar extends RecyclerView.Adapter<SelectorEdificiosAdaptar.ViewHolder> {
    ...
    public SelectorEdificiosAdaptar(List<Edificio> edificios, OnItemClickListener listener) {
